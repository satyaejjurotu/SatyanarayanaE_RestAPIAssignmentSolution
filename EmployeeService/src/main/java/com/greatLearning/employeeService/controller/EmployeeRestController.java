...
@Autowired
public EmployeeRestController(EmployeeServicetheEmployeeService) {
...
public Employee addEmployee(ORequestBodyEmployeetheEmployee){
...
public Employee updateEmployee (@Requestardy Employee theEmployee) {
employeeService. save (theEmployee);
return theEmployee;
